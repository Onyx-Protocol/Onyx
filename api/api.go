...
func tokenAuthedHandler() chainhttp.HandlerFunc {
	...
	h.HandleFunc("GET", "/v3/projects/:projID/manager-nodes", listWallets)
	h.HandleFunc("POST", "/v3/projects/:projID/manager-nodes", createWallet)
	h.HandleFunc("GET", "/v3/manager-nodes/:mnodeID", getWallet)
	...
	h.HandleFunc("GET", "/v3/manager-nodes/:mnodeID/transactions/:txID", walletTxActivity)
	h.HandleFunc("PUT", "/v3/manager-nodes/:mnodeID", updateManagerNode)
	h.HandleFunc("GET", "/v3/projects/:projID/issuer-nodes", listAssetGroups)
	h.HandleFunc("POST", "/v3/projects/:projID/issuer-nodes", createAssetGroup)
	h.HandleFunc("GET", "/v3/issuer-nodes/:inodeID", getAssetGroup)
