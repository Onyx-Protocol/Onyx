...
// Snapshot encompasses a snapshot of entire blockchain state.
...
func Copy(original *Snapshot) *Snapshot {
	...
	c := &Snapshot{
		InitialBlockHash: original.InitialBlockHash,
...
func NewSnapshot(initialBlockHash bc.Hash) *Snapshot {
	return &Snapshot{
