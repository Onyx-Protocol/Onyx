...
func TestPoolTxs(t *testing.T) {
	...
	_, err := dbtx.Exec(ctx, `
		...
		VALUES (
			'07dbdf6fa2af47d846bb59db57d6b3fb5147ea5434d3ddc44ec155f3c01897e4',
			decode('07010000000568656c6c6f', 'hex')
		);
	`)
	if err != nil {
...
func TestLatestBlock(t *testing.T) {
	...
	pgtest.Exec(dbctx, t, `
		...
		(
			...
			1,
			decode('', 'hex'),
			''
		);
	`)
