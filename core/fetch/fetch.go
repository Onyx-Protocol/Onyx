...
func Fetch(ctx context.Context, c *protocol.Chain, initialBlockHash bc.Hash, peer *rpc.Client, health func(error)) {
	...
	prevBlock, prevSnapshot, err := c.Recover(ctx, initialBlockHash)
	if err != nil {
