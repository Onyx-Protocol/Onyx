...
var policyByRoute = map[string][]string{
	...
	"/mockhsm":                  []string{"client-readwrite"},
	"/mockhsm/create-key":       []string{"client-readwrite"},
	"/mockhsm/list-keys":        []string{"client-readwrite", "client-readonly"},
	"/mockhsm/delkey":           []string{"client-readwrite"},
	"/mockhsm/sign-transaction": []string{"client-readwrite"},
