...
ExtHash             | [ExtStruct](#extension-struct) | If the transaction version is 1 or 2, this must be 32 zero-bytes.
...
ExtHash2           | [ExtStruct](#extension-struct)          | Hash of next extension struct. (See [ExtStruct](#extension-struct).) If the transaction version is 2, this must be 32 zero-bytes.
...
2. Fail validation if `Retirement1.UpgradeProgram` has VM version 0.
3. [Validate program](#program-validation) `Retirement1.UpgradeProgram` with the given `Arguments` and the transaction version.
4. [Validate](#value-destination-2) `Destination`.
5. If the transaction version is 1 or 2: verify that the `ExtHash` is the all-zero hash.
...
2. If the transaction version is 1 or 2: verify that the `ExtHash` is the all-zero hash.
...
6. If the transaction version is 1 or 2: verify that the `ExtHash` is the all-zero hash.
...
7. If the transaction version is 1 or 2: verify that the `ExtHash` is the all-zero hash.
...
3. If the transaction version is 1 or 2: verify that the `ExtHash` is the all-zero hash.
